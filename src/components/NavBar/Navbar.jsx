    ...
    return (
        <nav className='Navbar'>
            ...
            <div className='Categories'>
                ...
                <NavLink to={`/category/antojos`} className={({isActive}) => isActive ? 'ActiveOption' : 'Option'}>antojos</NavLink>
                <NavLink to={`/category/gustos`} className={({isActive}) => isActive ? 'ActiveOption' : 'Option'}>gustos</NavLink>
            </div>
            <CarWeight/>
        </nav>
    )
